...
public class ElementUtil extends BasePage {
	...
	public void doClick(By locator) {
		try {
			...
			System.out.println("some exception got occurred while clicking the web element.....");
		}
	...
	public void doSendkeys(By locator, String value) {
		try {
			...
			System.out.println("some exception got occurred while entering value in a feild ..");
		}
	...
	public String doGetText(By locator) {
		try {
			...
			System.out.println("some exception got occurred while getting  the  text from a web element.....");
		}
		return null;
	}
}
